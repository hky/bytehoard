...
<table class='toolbar' cellspacing='0' cellpadding='0' width='50%' align='center'>
	...
	<tr>
		...
		<td valign='middle' align='center'><br><br>
			...
			<table>
			<tr><td align='center' colspan='2'>".$bhlang['explain:deletefolder']."<br/><br/></td></tr>
			<tr>
			<td align='center'>
				<form action='index.php?page=viewdir&filepath=".$this->filepath."' method='POST'><input type='submit' value='".$bhlang['button:cancel']."'></form>
			</td>
			<td align='center'>
				<form action='index.php?page=deletefolder&filepath=".$this->filepath."' method='POST'><input type='hidden' name='dodelete' value='1'><input type='submit' value='".$bhlang['button:delete_folder']."'></form>
			</td>
			</tr>
			</table>
		</td>
