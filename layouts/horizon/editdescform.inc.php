...
<table class='toolbar' cellspacing='0' cellpadding='0' width='70%' align='center'>
	...
	<tr>
		...
		<td valign='middle' align='center'><br><br><table><tr><td align='center'>
			".$bhlang['explain:editdesc']."<br/><br/></td></tr><tr><td align='center'>
			<form action='index.php?page=editdesc&filepath=".$this->filepath."' method='POST'>
			<table>
			<tr><td align='center'><textarea name='description' rows='2' cols='80'>".$this->content1."</textarea>
			<input type='hidden' name='isdescription' value='1'></td></tr>
			<tr><td align='center'><input type='submit' value='".$bhlang['button:savedesc']."'></td></tr>
			</table>
			</form>
			</td></tr></table>
		</td>
