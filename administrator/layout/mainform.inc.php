...
<table class='toolbar' cellspacing='0' cellpadding='0' width='90%' align='center'>
	...
	<tr height='30'>
		...
		<td background='".$this->skinpath."images/sidebar/titlebg.png' align='center' valign='middle'><b>".$bhlang['title:welcome_to_administration']."</b></td>
	...
	<tr>
		...
		<td valign='middle' align='center'><br><br>
			".$bhlang['explain:welcome_to_administration']."<br><br>
