...
// | Adapted by: Andrew Godwin <andrew@bytehoard.org> for ByteHoard       |
// +----------------------------------------------------------------------+
//
// $Id: server.php,v 1.1 2005/06/17 18:52:01 andrewgodwin Exp $
//
require_once $bhconfig['bhfilepath']."/includes/webdav/_parse_propfind.php";
require_once $bhconfig['bhfilepath']."/includes/webdav/_parse_proppatch.php";
require_once $bhconfig['bhfilepath']."/includes/webdav/_parse_lockinfo.php";
